    ...
    <Section section="about-me">
      <div className="profile-teaser media flex-column flex-lg-row">
        <div className="media-body">
          ...
          <Bio mb="4">
            I'm a web developer specialised in Frontend & Backend development on Javascript
            applications.
          </Bio>
          <div className="mb-4">
            <Link href="/portfolio">
              <a className="btn btn-primary mr-2 mb-3">
                <FontAwesomeIcon icon={faArrowCircleRight} size="lg" className="mr-1" /> See
                Portfolio
              </a>
            </Link>
            <Link href="/resume">
              <a className="btn btn-secondary mb-3">
                <FontAwesomeIcon icon={faFileAlt} size="lg" className="mr-1" /> See Resume
              </a>
            </Link>
          </div>
        </div>
