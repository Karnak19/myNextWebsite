      ...
      <div className="media flex-column flex-md-row align-items-center">
        ...
        <div className="media-body text-left">
          <p className="mb-0">
            ...
            molestias vel unde asperiores tenetur, voluptas itaque! Deserunt
            distinctio, earum sunt doloribus itaque sint blanditiis excepturi
            fugit, porro asperiores molestiae sapiente labore assumenda
